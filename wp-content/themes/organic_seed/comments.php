...
* handled by a callback to seed_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				...
				* to use seed_comment() to format the comments.
				* If you want to overload this in a child theme then you can
				* define seed_comment() and that will be used instead.
				* See seed_comment() in organicthemes/functions.php for more.
				*/
				wp_list_comments( array( 'callback' => 'seed_comment' ) );
			?>
		</ol>
